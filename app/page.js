...
export default function LoginPage() {
  ...
  function handleSubmit(event) {
    ...
    setMessage("A bejelentkezést a következő lépésben kötjük össze a Supabase rendszerrel.");
  }
      ...
      <section className="hero" aria-labelledby="hero-title">
        ...
        <form className="login-card" onSubmit={handleSubmit} noValidate>
          ...
          <div className="input-wrap">
            <MailIcon />
            <input id="email" name="email" type="email" placeholder="E-mail-cím" autoComplete="email" required />
          </div>

          <label htmlFor="password">Jelszó</label>
          <div className="input-wrap">
            <LockIcon />
            <input id="password" name="password" type={showPassword ? "text" : "password"} placeholder="Jelszó" autoComplete="current-password" required />
          ...
          <button className="primary-button" type="submit">Belépés</button>
          <div className="divider" />
          <a className="register-link" href="/regisztracio">Regisztráció</a>
        </form>
      </section>
    </main>
  );
